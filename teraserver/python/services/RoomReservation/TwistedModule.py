...
class TwistedModule(BaseModule):
    ...
    def __init__(self, config: ConfigManager):
        ...
        BaseModule.__init__(self, 'RoomReservationService.TwistedModule', config)
    ...
    def notify_module_messages(self, pattern, channel, message):
        ...
        """
        print('RoomReservationService.TwistedModule - Received message ', pattern, channel, message)
        pass
