...
flask_app = Flask("RoomReservationService")
...
api = Api(flask_app,
          ...
          description='RoomReservationService API Documentation', doc='/doc',
...
class FlaskModule(BaseModule):
    ...
    def __init__(self,  config: ConfigManager):
        ...
        BaseModule.__init__(self, "RoomReservationService.FlaskModule", config)
        ...
        flask_app.secret_key = 'RoomReservationSecret'
    ...
    def notify_module_messages(self, pattern, channel, message):
        ...
        """
        print('RoomReservationService.FlaskModule - Received message ', pattern, channel, message)
        pass
